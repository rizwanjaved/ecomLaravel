    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <input type="hidden" name="app_version" value="4.0.6">

                <div class="form-group {{ $errors->has('app_version') ? ' has-error ' : '' }}">
                    <label for="app_version">
                        App Version
                    </label>
                    <input type="text" name="app_version" id="app_version" value="4.0.6" placeholder="App Version" disabled/>
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="{{ old('app_name') }}" placeholder="App Name" />
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="{{ old('app_url') }}" placeholder="APP_URL" />
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="password" name="database_password" id="database_password" value="{{ old('database_password') }}" placeholder="Database Passwords" />
                ...
                <!-- <div class="block">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group {{ $errors->has('mail_driver') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_driver" id="mail_driver" value="" placeholder="Mail Driver" />
                        ...
                        <div class="form-group {{ $errors->has('mail_host') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_host" id="mail_host" value="" placeholder="Mail Host" />
                        ...
                        <div class="form-group {{ $errors->has('mail_port') ? ' has-error ' : '' }}">
                            ...
                            <input type="number" name="mail_port" id="mail_port" value="" placeholder="Mail Port" />
                        ...
                        <div class="form-group {{ $errors->has('mail_username') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_username" id="mail_username" value="" placeholder="Mail Username" />
                        ...
                        <div class="form-group {{ $errors->has('mail_password') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_password" id="mail_password" value="" placeholder="Mail Password" />
                        ...
                        <div class="form-group {{ $errors->has('mail_encryption') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_encryption" id="mail_encryption" value="" placeholder="Mail Encryption" />
            ...
            <div class="tab" id="tab4content">
                ...
                <div class="form-group {{ $errors->has('password_confirm') ? ' has-error ' : '' }}">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirm" value="{{ old('password_confirmation') }}" placeholder="Confirm Password" />
